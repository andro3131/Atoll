...
odlozisce_novo = r"G:\Avtomatika\Eksport\Upravicenost_bazne_postaje\Novo\\"
odlozisce_spremeni = r"G:\Avtomatika\Eksport\Upravicenost_bazne_postaje\Spremeni\\"
odlozisce_brisi = r"G:\Avtomatika\Eksport\Upravicenost_bazne_postaje\Brisi\\"
odlozisce_filter = r"G:\Avtomatika\Eksport\Upravicenost_bazne_postaje\\"

mapa_upravicenost = r"G:\Pokrivanja\Upravicenost_bazne_postaje_v1\\"
mapa_upravicenost_temp = r"G:\Pokrivanja\Upravicenost_bazne_postaje_temp\\"
fajl_celice = r"G:\Avtomatika\Eksport\\Upravicenost_bp_celice.txt"
fajl_lokacija = r"G:\Avtomatika\Eksport\\Upravicenost_bp_krmilna_tabela.xlsx"
mapa_kompozit = r"G:\Pokrivanja\Arcgis\export_3794\Sestic\Kompozit\\"
...
def main():
    ...
    if (tabela[tabela['Obstojec'] == False].shape[0] > 0):
        ...
        subprocess.run(['cscript','C:\\Users\\planer02\\Skripte\\VBasic\\posodobi_atoll_3794_update_planirano_v1.vbs'],   capture_output=True,  text=True)
        t2 = time.time()
    ...
    for i in tabela.index:
        ...
        izracunaj_stevilke(mapa = mapa_upravicenost + key + '\\', lokacija = key, resolucija = 25, celice = celice_)
