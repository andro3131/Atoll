...
SharedOutputFolder = "D:\Atoll_projects_planer01\Atoll_dokumenti\Dokument_exporti\SharedPathlossData\"

Set log1 = objFs.OpenTextFile("D:\Atoll_projects_planer01\Avtomatika\log\Atoll_import_vbs_log.txt", 8, True)
' -----------------------------------------------------------------------------------------------------------------------
...
Set log = objFSO.OpenTextFile("D:\Atoll_projects_planer01\Avtomatika\log\Atoll_import_vbs_log.txt", 8, True)

' objDocumentAtoll.Refresh   ' ZAKOMENTIRANO na planer01 - povozilo bi D:\ pathloss config (memory 2026-04-24 finding)
If Err.Number <> 0 Then
...
If cs.GetValue(1,"CODE") = 3912 Then
	strPath_novo = "D:\Atoll_projects_planer01\Avtomatika\EPSG_3912\Novo\"
	strPath_spremeni = "D:\Atoll_projects_planer01\Avtomatika\EPSG_3912\Spremeni\"
	strPath_brisi = "D:\Atoll_projects_planer01\Avtomatika\EPSG_3912\Brisi\"
Elseif cs.GetValue(1,"CODE") = 3794 Then
	strPath_novo = "D:\Atoll_projects_planer01\Avtomatika\EPSG_3794\Novo\"
	strPath_spremeni = "D:\Atoll_projects_planer01\Avtomatika\EPSG_3794\Spremeni\"
	strPath_brisi = "D:\Atoll_projects_planer01\Avtomatika\EPSG_3794\Brisi\"
Elseif cs.GetValue(1,"CODE") = 4326 Then
	strPath_novo = "D:\Atoll_projects_planer01\Avtomatika\WGS84\Novo\"
	strPath_spremeni = "D:\Atoll_projects_planer01\Avtomatika\WGS84\Spremeni\Atributi\"
	strPath_brisi = "D:\Atoll_projects_planer01\Avtomatika\WGS84\Brisi\"
End If
...
Set m = objFSO.OpenTextFile("D:\Atoll_projects_planer01\Avtomatika\Eksport\fajl.txt", 1)
...
If objFolder_brisi.Files.Count > 0 Then
	...
	Next
	Set objFile = Nothing
	' objDocumentAtoll.Archive   ' ZAKOMENTIRANO na planer01 - povozilo bi atoll_d96 SQL s strani Zige
	If Err.Number <> 0 Then
		log.WriteLine Now & " – ERROR " & Err.Number & ": " & Err.Description
		Err.Clear
	End If
	...
	WScript.Sleep 1000
	Loop
	' objDocumentAtoll.Refresh   ' ZAKOMENTIRANO na planer01
	If Err.Number <> 0 Then
		log.WriteLine Now & " – ERROR " & Err.Number & ": " & Err.Description
		Err.Clear
	End If
